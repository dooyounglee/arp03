...
<nav class="navbar top-navbar navbar-expand-md navbar-light">
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="/${cp}"> <!-- Logo icon --> <b>
				<!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
				<!-- Dark Logo icon --> <img
				src="/${cp }/resources/material-pro/assets/images/logo-icon.png"
				alt="homepage" class="dark-logo" /> <!-- Light Logo icon --> <img
				src="/${cp }/resources/material-pro/assets/images/logo-light-icon.png"
				alt="homepage" class="light-logo" />
		</b> <!--End Logo icon --> <!-- Logo text --> <span class="light-logo">
				<!-- dark Logo text --> <%-- <img src="/${cp }/resources/material-pro/assets/images/logo-text.png" alt="homepage" class="dark-logo" /> --%>
				<!-- Light Logo text --> <%-- <img src="/${cp }/resources/material-pro/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /> --%>
				KH수학교육원
		</span>
		</a>
